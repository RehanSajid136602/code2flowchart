...
import { RefreshCw, Mail, Lock, User, Eye, EyeOff } from 'lucide-react';
...
export default function SignupClient() {
  ...
  return (
    <div className="auth-body signup-page">
      <AuthBackground />

      <div className="auth-container">
        <nav className="auth-tab-nav">
          <Link href="/login" className="auth-tab-btn">Sign In</Link>
          <Link href="/signup" className="auth-tab-btn active">Sign Up</Link>
          <div className="auth-tab-slider signup" />
        </nav>

        <form className="auth-form" onSubmit={(e) => { e.preventDefault(); handle(() => signUpWithEmail({ email, password, displayName: fullName })); }}>
